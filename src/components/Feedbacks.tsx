...
import { TestimonialType } from "../model"
import SectionWrapper from "../hoc/SectionWrapper.tsx"

const FeedbackCard = ({ index, testimonial }: { index: number; testimonial: TestimonialType }) => (
    <motion.div
...
const NaiveFeedbacks = () => {
    return (
        <div className={"mt-12 bg-black-100 rounded-[20px]"}>
            ...
            <div className={`${styles.paddingX} -mt-20 ps-14 flex flex-wrap gap-7`}>
...
const Feedbacks = SectionWrapper(NaiveFeedbacks, "feedbacks")
